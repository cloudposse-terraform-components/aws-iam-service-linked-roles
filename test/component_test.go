...
func (s *ComponentSuite) TestBasic() {
	...
	assert.Equal(s.T(), role["spot_amazonaws_com_test"].Tags.Attributes, "esmqfl")
	assert.Equal(s.T(), role["spot_amazonaws_com_test"].Tags.Environment, "ue2")
	assert.Equal(s.T(), role["spot_amazonaws_com_test"].Tags.Name, "eg-default-ue2-test-esmqfl")
